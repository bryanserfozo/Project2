 ...
 */
export class BookingTableDataSource extends DataSource<IBookHistory> {
  data: IBookHistory[] = bookData;
   ...
   */
  connect(): Observable<IBookHistory[]> {
   ...
   */
  private getPagedData(data: IBookHistory[]): IBookHistory[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: IBookHistory[]): IBookHistory[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'dateBook': return compare(+a.dateBook, +b.dateBook, isAsc);
        default: return 0;
      }
    });
  }
