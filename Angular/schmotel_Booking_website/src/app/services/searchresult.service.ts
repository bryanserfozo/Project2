...
//   }
 ...
 callApi(): Observable<any> {
  ...
  .set('x-rapidapi-key', '1102d71a47msh51a4afddc13a729p1720b3jsn54bd62d2efb3');
  ...
  const params = new HttpParams()
   ...
   console.log("request is send");
   return this.httpclient.get("https://hotels4.p.rapidapi.com/locations/v2/search", {headers :headers, params: params});
